...
SCENARIOS_ROUND26: list[Scenario] = [
    Scenario(
        case_id="GOAL-251",
        title="salesforce admin certification",
        description="我要准备 Salesforce Administrator 认证，三个月内通过，请安排复习并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-09",
            "available_time": {"type": "daily", "minutes": 55},
            "raw_answers": {"exam_name": "Salesforce Administrator"},
            "confirm": True,
        },
        feedbacks=("今天完成了用户权限和对象模型的一套练习题。",),
        expected_statuses=("done",),
    ),
    Scenario(
        case_id="GOAL-252",
        title="duolingo english test speaking",
        description="我想准备 Duolingo English Test 英语口语，目标一个半月提高到 120，请每天陪练并监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "口语表达不稳定",
            "target_level": "Duolingo English Test 120",
            "available_time": {"type": "daily", "minutes": 35},
            "raw_answers": {"target_language": "英语", "exam_name": "Duolingo English Test"},
            "confirm": True,
        },
        feedbacks=("今天录完了两段口语题，但错词复盘还没做。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-253",
        title="qwik bun hono edge api",
        description="我想学 Qwik、Bun 和 Hono，做一个边缘 API 小项目，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点 TypeScript，不熟边缘运行时",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {
                "language_or_track": "Qwik Bun Hono TypeScript",
                "project_goal": "边缘 API 小项目",
            },
            "confirm": True,
        },
        feedbacks=("今天卡在 Hono 路由和 Bun 测试脚本配置。",),
        expected_statuses=("blocked",),
    ),
    Scenario(
        case_id="GOAL-254",
        title="pullup strength basics",
        description="我想练引体向上基础力量，先做到连续 3 个标准动作，请每天提醒和监督。",
        expected_domain="fitness",
        intake={
            "current_level": "目前还做不了标准引体",
            "available_time": {"type": "daily", "minutes": 20},
            "constraints": {"health_note": "肩肘疼痛时停止训练"},
            "confirm": True,
        },
        feedbacks=("今天练了一半辅助引体，肩胛激活还没做完。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-255",
        title="home declutter habit",
        description="我想建立家庭断舍离习惯，每周整理一个柜子或区域，请监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-08",
            "available_time": {"type": "weekly", "minutes": 90},
            "raw_answers": {"success_criteria": "每周整理一个柜子或区域并记录去留"},
            "confirm": True,
        },
        feedbacks=("今天整理完了玄关柜。",),
        expected_statuses=("done",),
    ...
    Scenario(
        case_id="GOAL-256",
        title="tcf quebec french",
        description="我要准备 TCF Québec 法语考试，重点练听力和口语，请每天监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "A2 到 B1 之间",
            "target_level": "TCF Québec 听力和口语提分",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {"target_language": "法语", "exam_name": "TCF Québec"},
            "confirm": True,
        },
        feedbacks=("今天只听了一段新闻材料，口语没时间完成。",),
        expected_statuses=("missed",),
    ),
    Scenario(
        case_id="GOAL-257",
        title="godot pixel game",
        description="我想学 Godot 和 GDScript，做一个像素风平台跳跃游戏 demo，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点编程，不熟游戏引擎",
            "available_time": {"type": "daily", "minutes": 50},
            "raw_answers": {
                "language_or_track": "Godot GDScript",
                "project_goal": "像素风平台跳跃游戏 demo",
            },
            "confirm": True,
        },
        feedbacks=("今天完成了角色移动和碰撞，但关卡切换还没做。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-258",
        title="table tennis footwork",
        description="我想练乒乓球步伐和反手稳定性，请每周监督训练。",
        expected_domain="fitness",
        intake={
            "current_level": "业余新手，步伐慢，反手不稳",
            "available_time": {"type": "weekly", "minutes": 120},
            "constraints": {"health_note": "手腕或膝盖疼痛时降低强度"},
            "confirm": True,
        },
        feedbacks=("今天没训练，手腕有点疼。", "今天还是休息了，怕加重。"),
        expected_statuses=("missed", "missed"),
        expect_intervention=True,
        schedule={"type": "weekly", "days": [2, 6], "time": "19:30"},
    ),
    Scenario(
        case_id="GOAL-259",
        title="insurance policy review",
        description="我想建立家庭保险保单复盘习惯，每季度整理保障范围和缴费记录，请监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-12",
            "available_time": {"type": "weekly", "minutes": 40},
            "raw_answers": {"success_criteria": "完成家庭保单清单、保障范围和缴费记录复盘"},
            "confirm": True,
        },
        feedbacks=("今天整理完了医疗险和意外险清单，但缴费记录还没核对。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [6], "time": "20:30"},
    ),
    Scenario(
        case_id="GOAL-260",
        title="scrum master certification",
        description="我要准备 Professional Scrum Master I 认证，两个月内通过，请安排学习计划并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-08",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {"exam_name": "Professional Scrum Master I"},
            "confirm": True,
        },
        feedbacks=("今天完成了 Scrum Guide 第一遍阅读和一套模拟题。",),
        expected_statuses=("done",),
    ),
]


SCENARIOS_ROUND27: list[Scenario] = [
    Scenario(
        case_id="GOAL-261",
        title="isc2 certified in cybersecurity",
        description="我要准备 ISC2 Certified in Cybersecurity 认证，两个月内通过，请安排复习并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-08",
            "available_time": {"type": "daily", "minutes": 50},
            "raw_answers": {"exam_name": "ISC2 Certified in Cybersecurity"},
            "confirm": True,
        },
        feedbacks=("今天完成了访问控制和安全运营的一套练习题。",),
        expected_statuses=("done",),
    ),
    Scenario(
        case_id="GOAL-262",
        title="cambridge b2 first",
        description="我想准备 Cambridge B2 First 英语考试，重点提升阅读和写作，请每天陪练并监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "B1 到 B2 之间",
            "target_level": "Cambridge B2 First 阅读和写作达标",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {"target_language": "英语", "exam_name": "Cambridge B2 First"},
            "confirm": True,
        },
        feedbacks=("今天做了一半阅读题，写作改错还没完成。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-263",
        title="deno fresh edge app",
        description="我想学 Deno 和 Fresh，做一个边缘渲染小应用，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点 TypeScript，不熟 Deno 运行时",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {
                "language_or_track": "Deno Fresh TypeScript",
                "project_goal": "边缘渲染小应用",
            },
            "confirm": True,
        },
        feedbacks=("今天卡在 Fresh islands 和 Deno deploy 环境变量配置。",),
        expected_statuses=("blocked",),
    ),
    Scenario(
        case_id="GOAL-264",
        title="kettlebell swing basics",
        description="我想练壶铃摆动基础动作和髋部发力，请每周监督训练。",
        expected_domain="fitness",
        intake={
            "current_level": "力量基础一般，髋部发力不熟",
            "available_time": {"type": "weekly", "minutes": 90},
            "constraints": {"health_note": "腰背不适时停止训练"},
            "confirm": True,
        },
        feedbacks=("今天练了一半髋铰链动作，壶铃摆动还没做完。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [2, 6], "time": "19:30"},
    ),
    Scenario(
        case_id="GOAL-265",
        title="gratitude journal habit",
        description="我想建立每天感恩日志习惯，连续 30 天记录三件小事，请提醒和监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-07",
            "available_time": {"type": "daily", "minutes": 8},
            "raw_answers": {"success_criteria": "连续 30 天记录三件感恩小事"},
            "confirm": True,
        },
        feedbacks=("今天写完了三件小事。",),
        expected_statuses=("done",),
    ...
    Scenario(
        case_id="GOAL-266",
        title="yki finnish a2",
        description="我要准备 YKI 芬兰语 A2 考试，重点练听力和口语，请每天监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "A1 左右",
            "target_level": "YKI 芬兰语 A2",
            "available_time": {"type": "daily", "minutes": 35},
            "raw_answers": {"target_language": "芬兰语", "exam_name": "YKI A2"},
            "confirm": True,
        },
        feedbacks=("今天只听了一段对话，口语没时间完成。",),
        expected_statuses=("missed",),
    ),
    Scenario(
        case_id="GOAL-267",
        title="phoenix liveview chat",
        description="我想学 Phoenix LiveView，做一个实时聊天小项目，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点后端，不熟 Elixir 和 LiveView",
            "available_time": {"type": "daily", "minutes": 50},
            "raw_answers": {
                "language_or_track": "Phoenix LiveView Elixir",
                "project_goal": "实时聊天小项目",
            },
            "confirm": True,
        },
        feedbacks=("今天完成了频道页面和消息表，但实时更新还没接好。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-268",
        title="paddleboard balance",
        description="我想练桨板平衡和基础转向，请每周监督训练。",
        expected_domain="fitness",
        intake={
            "current_level": "新手，站立平衡不稳",
            "available_time": {"type": "weekly", "minutes": 120},
            "constraints": {"health_note": "注意水域安全，不适时停止训练"},
            "confirm": True,
        },
        feedbacks=("今天没训练，肩膀有点不舒服。", "今天还是休息了，怕影响恢复。"),
        expected_statuses=("missed", "missed"),
        expect_intervention=True,
        schedule={"type": "weekly", "days": [3, 7], "time": "18:30"},
    ),
    Scenario(
        case_id="GOAL-269",
        title="family recipe archive",
        description="我想建立家庭食谱归档习惯，每周整理一道菜的步骤和照片，请监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-09",
            "available_time": {"type": "weekly", "minutes": 60},
            "raw_answers": {"success_criteria": "整理家庭食谱步骤和照片"},
            "confirm": True,
        },
        feedbacks=("今天整理完了红烧排骨的步骤，但照片还没归档。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [7], "time": "20:00"},
    ),
    Scenario(
        ...
        description="我要准备 Google Analytics Certification，两个月内通过，请安排学习计划并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-08",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {"exam_name": "Google Analytics Certification"},
            "confirm": True,
        },
        feedbacks=("今天完成了事件追踪和报表配置章节练习。",),
        expected_statuses=("done",),
    ),
]


SCENARIOS_ROUND28: list[Scenario] = [
    Scenario(
        case_id="GOAL-271",
        title="aws solutions architect associate",
        description="我要准备 AWS Solutions Architect Associate 认证，三个月内通过，请安排复习并监督。",
        ...
        feedbacks=("今天完成了 VPC 和高可用架构章节练习。",),
        expected_statuses=("done",),
    ),
    Scenario(
        case_id="GOAL-272",
        title="celi b2 italian",
        description="我要准备 CELI B2 意大利语考试，重点练写作和听力，请每天监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "B1 到 B2 之间",
            "target_level": "CELI B2 写作和听力达标",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {"target_language": "意大利语", "exam_name": "CELI B2"},
            "confirm": True,
        },
        feedbacks=("今天听力练了一半，写作提纲还没写完。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-273",
        title="astro cloudflare workers site",
        description="我想学 Astro 和 Cloudflare Workers，用 TypeScript 做一个边缘内容站，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点前端，不熟边缘部署",
            "available_time": {"type": "daily", "minutes": 50},
            "raw_answers": {
                "language_or_track": "Astro Cloudflare Workers TypeScript",
                "project_goal": "边缘内容站",
            },
            "confirm": True,
        },
        feedbacks=("今天卡在 Workers 路由和环境变量绑定。",),
        expected_statuses=("blocked",),
    ),
    Scenario(
        case_id="GOAL-274",
        title="pilates core stability",
        description="我想练普拉提核心稳定和髋部灵活性，请每周监督训练。",
        expected_domain="fitness",
        intake={
            "current_level": "核心力量一般，髋部比较紧",
            "available_time": {"type": "weekly", "minutes": 100},
            "constraints": {"health_note": "腰背不适时降低强度"},
            "confirm": True,
        },
        feedbacks=("今天练了一半核心动作，髋部拉伸还没做完。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [2, 5], "time": "19:20"},
    ),
    Scenario(
        case_id="GOAL-275",
        title="weekly reading notes habit",
        description="我想建立每周整理读书笔记的习惯，把一本书的要点和行动项沉淀下来，请监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-09",
            "available_time": {"type": "weekly", "minutes": 60},
            "raw_answers": {"success_criteria": "每周整理一份读书笔记和行动项"},
            "confirm": True,
        },
        feedbacks=("今天整理完了前三章要点，但行动项还没提炼。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [7], "time": "20:30"},
    ),
    Scenario(
        case_id="GOAL-276",
        title="celpip english writing",
        description="我要准备 CELPIP 英语写作，目标两个月提到 8 分，请每天陪练并监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "写作结构不稳定",
            "target_level": "CELPIP 写作 8 分",
            "available_time": {"type": "daily", "minutes": 40},
            "raw_answers": {"target_language": "英语", "exam_name": "CELPIP"},
            "confirm": True,
        },
        feedbacks=("今天只写了开头段，主体段没时间完成。",),
        expected_statuses=("missed",),
    ),
    Scenario(
        case_id="GOAL-277",
        title="rust webassembly widget",
        description="我想学 Rust 和 WebAssembly，做一个浏览器里的小组件，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点 Rust 基础，不熟 wasm-bindgen",
            "available_time": {"type": "daily", "minutes": 55},
            "raw_answers": {
                "language_or_track": "Rust WebAssembly wasm-bindgen",
                "project_goal": "浏览器小组件",
            },
            "confirm": True,
        },
        feedbacks=("今天完成了 Rust 函数导出和页面调用，但打包优化还没做。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-278",
        title="jump rope cardio",
        description="我想练跳绳耐力，目标连续跳 10 分钟，请每天提醒和监督。",
        expected_domain="fitness",
        intake={
            "current_level": "目前只能连续跳 2 分钟",
            "available_time": {"type": "daily", "minutes": 20},
            "constraints": {"health_note": "膝盖或脚踝不适时停止训练"},
            "confirm": True,
        },
        feedbacks=("今天没跳绳，脚踝有点不舒服。", "今天还是休息了，怕加重。"),
        expected_statuses=("missed", "missed"),
        expect_intervention=True,
    ),
    Scenario(
        case_id="GOAL-279",
        title="monthly budget envelope habit",
        description="我想建立每月信封预算复盘习惯，记录各类支出和下月额度，请监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-12",
            "available_time": {"type": "weekly", "minutes": 35},
            "raw_answers": {"success_criteria": "每月完成支出分类、额度复盘和下月预算"},
            "confirm": True,
        },
        feedbacks=("今天完成了餐饮和交通支出分类，但下月额度还没定。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [6], "time": "19:40"},
    ),
    Scenario(
        case_id="GOAL-280",
        title="azure ai fundamentals certification",
        description="我要准备 Azure AI Fundamentals Certification，一个半月内通过，请安排学习计划并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-08",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {"exam_name": "Azure AI Fundamentals Certification"},
            "confirm": True,
        },
        feedbacks=("今天完成了机器学习基础和认知服务章节练习。",),
        expected_statuses=("done",),
    ),
]


SCENARIOS_ROUND29: list[Scenario] = [
    Scenario(
        case_id="GOAL-281",
        title="comptia network plus",
        description="我要准备 CompTIA Network+ Certification，两个月内通过，请安排复习并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-08",
            "available_time": {"type": "daily", "minutes": 50},
            "raw_answers": {"exam_name": "CompTIA Network+"},
            "confirm": True,
        },
        feedbacks=("今天完成了子网划分和网络故障排查章节练习。",),
        expected_statuses=("done",),
    ),
    Scenario(
        case_id="GOAL-282",
        title="topik ii korean writing",
        description="我要准备 TOPIK II 韩语写作和阅读，目标三个月提分，请每天监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "TOPIK II 初段水平",
            "target_level": "TOPIK II 写作和阅读提分",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {"target_language": "韩语", "exam_name": "TOPIK II"},
            "confirm": True,
        },
        feedbacks=("今天做了一半阅读题，写作范文还没复盘。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-283",
        title="nextjs prisma auth dashboard",
        description="我想学 Next.js 和 Prisma，用 TypeScript 做一个带登录的管理后台，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点 React，不熟服务端渲染和 ORM",
            "available_time": {"type": "daily", "minutes": 55},
            "raw_answers": {
                "language_or_track": "Next.js Prisma TypeScript",
                "project_goal": "带登录的管理后台",
            },
            "confirm": True,
        },
        feedbacks=("今天卡在 Prisma schema 关系和登录 session 配置。",),
        expected_statuses=("blocked",),
    ),
    Scenario(
        case_id="GOAL-284",
        title="five kilometer running",
        description="我想从零开始练 5 公里跑步，目标两个月能连续跑完，请每天提醒和监督。",
        expected_domain="fitness",
        intake={
            "current_level": "目前跑一会儿就喘",
            "available_time": {"type": "daily", "minutes": 25},
            "constraints": {"health_note": "膝盖或脚踝疼痛时停止训练"},
            "confirm": True,
        },
        feedbacks=("今天没跑步，膝盖有点不舒服。", "今天还是休息了，怕加重。"),
        expected_statuses=("missed", "missed"),
        expect_intervention=True,
    ),
    Scenario(
        case_id="GOAL-285",
        title="inbox zero habit",
        description="我想建立邮箱收件箱归零习惯，每天处理重要邮件并清理待办，请监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-08",
            "available_time": {"type": "daily", "minutes": 15},
            "raw_answers": {"success_criteria": "每天处理重要邮件并清空待办邮件"},
            "confirm": True,
        },
        feedbacks=("今天处理完了重要邮件，但订阅邮件还没清理。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-286",
        title="siele spanish speaking",
        description="我要准备 SIELE 西班牙语口语，目标两个月提升流利度，请每天陪练并监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "A2 到 B1 之间",
            "target_level": "SIELE 口语更流利",
            "available_time": {"type": "daily", "minutes": 35},
            "raw_answers": {"target_language": "西班牙语", "exam_name": "SIELE"},
            "confirm": True,
        },
        feedbacks=("今天只练了自我介绍，图片描述没时间完成。",),
        expected_statuses=("missed",),
    ),
    Scenario(
        case_id="GOAL-287",
        title="go grpc microservice",
        description="我想学 Go 和 gRPC，做一个订单微服务 demo，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点 Go 基础，不熟 gRPC 和 protobuf",
            "available_time": {"type": "daily", "minutes": 50},
            "raw_answers": {
                "language_or_track": "Go gRPC protobuf",
                "project_goal": "订单微服务 demo",
            },
            "confirm": True,
        },
        feedbacks=("今天完成了 proto 定义和服务骨架，但错误处理还没补。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-288",
        title="yoga shoulder mobility",
        description="我想练瑜伽肩颈灵活性和胸椎打开，请每周监督训练。",
        expected_domain="fitness",
        intake={
            "current_level": "肩颈紧，胸椎活动度一般",
            "available_time": {"type": "weekly", "minutes": 90},
            "constraints": {"health_note": "肩颈疼痛时降低强度"},
            "confirm": True,
        },
        feedbacks=("今天练了一半肩颈拉伸，胸椎打开还没做完。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [1, 4], "time": "20:00"},
    ),
    Scenario(
        case_id="GOAL-289",
        title="family photo backup habit",
        description="我想建立家庭照片备份整理习惯，每周归档一批照片并标注日期地点，请监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-10",
            "available_time": {"type": "weekly", "minutes": 50},
            "raw_answers": {"success_criteria": "每周归档照片并标注日期地点"},
            "confirm": True,
        },
        feedbacks=("今天整理完了一批照片，但日期地点还没标完。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [7], "time": "19:30"},
    ),
    Scenario(
        case_id="GOAL-290",
        title="tableau desktop specialist certification",
        description="我要准备 Tableau Desktop Specialist Certification，两个月内通过，请安排学习计划并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-08",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {"exam_name": "Tableau Desktop Specialist Certification"},
            "confirm": True,
        },
        feedbacks=("今天完成了数据连接和基础图表章节练习。",),
        expected_statuses=("done",),
    ),
]


SCENARIOS_ROUND30: list[Scenario] = [
    Scenario(
        case_id="GOAL-291",
        title="cka kubernetes administrator",
        description="我要准备 Certified Kubernetes Administrator 认证，三个月内通过，请安排复习并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-09",
            "available_time": {"type": "daily", "minutes": 60},
            "raw_answers": {"exam_name": "Certified Kubernetes Administrator"},
            "confirm": True,
        },
        feedbacks=("今天完成了 Pod 调度和集群排错章节练习。",),
        expected_statuses=("done",),
    ),
    Scenario(
        case_id="GOAL-292",
        title="oet english healthcare",
        description="我要准备 OET 医护英语考试，重点练听力和写作，请每天陪练并监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "医学场景词汇不稳定",
            "target_level": "OET 听力和写作达标",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {"target_language": "英语", "exam_name": "OET"},
            "confirm": True,
        },
        feedbacks=("今天听力做了一半，转诊信写作还没完成。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-293",
        title="react native expo habit app",
        description="我想学 React Native 和 Expo，做一个习惯打卡 App，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点 React，不熟移动端开发",
            "available_time": {"type": "daily", "minutes": 50},
            "raw_answers": {
                "language_or_track": "React Native Expo TypeScript",
                "project_goal": "习惯打卡 App",
            },
            "confirm": True,
        },
        feedbacks=("今天卡在 Expo 路由和本地通知权限配置。",),
        expected_statuses=("blocked",),
    ),
    Scenario(
        case_id="GOAL-294",
        title="badminton footwork endurance",
        description="我想练羽毛球步伐和耐力，目标一个月内移动更稳定，请每周监督训练。",
        expected_domain="fitness",
        intake={
            "current_level": "步伐慢，连续多拍后容易累",
            "available_time": {"type": "weekly", "minutes": 120},
            "constraints": {"health_note": "膝盖或脚踝不适时降低强度"},
            "confirm": True,
        },
        feedbacks=("今天练了一半米字步，耐力组还没做完。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [2, 6], "time": "19:30"},
    ),
    Scenario(
        case_id="GOAL-295",
        title="morning planning habit",
        description="我想建立每天晨间计划习惯，列出三件最重要的事并晚上复盘，请提醒和监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-08",
            "available_time": {"type": "daily", "minutes": 10},
            "raw_answers": {"success_criteria": "每天写三件重要事项并晚上复盘"},
            "confirm": True,
        },
        feedbacks=("今天写完了三件事，但晚上复盘还没做。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-296",
        title="gmat quant verbal",
        description="我要准备 GMAT Focus Edition，重点提升 Quant 和 Verbal，三个月内考试，请安排学习计划并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-09",
            "available_time": {"type": "daily", "minutes": 75},
            "raw_answers": {"exam_name": "GMAT Focus Edition"},
            "confirm": True,
        },
        feedbacks=("今天只做了 Quant 错题，Verbal 阅读没时间完成。",),
        expected_statuses=("missed",),
    ),
    Scenario(
        case_id="GOAL-297",
        title="haskell cli parser",
        description="我想学 Haskell，做一个命令行文本解析工具，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点函数式概念，不熟 Haskell 语法",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {
                "language_or_track": "Haskell CLI parser",
                "project_goal": "命令行文本解析工具",
            },
            "confirm": True,
        },
        feedbacks=("今天完成了基础类型和解析函数，但命令行参数还没接好。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-298",
        title="daily meditation habit",
        description="我想建立每天 10 分钟冥想习惯，降低焦虑和分心，请提醒并监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-08",
            "available_time": {"type": "daily", "minutes": 10},
            "raw_answers": {"success_criteria": "每天完成 10 分钟冥想并记录状态"},
            "confirm": True,
        },
        feedbacks=("今天没冥想，整晚都在赶事。", "今天还是没做，睡前太累了。"),
        expected_statuses=("missed", "missed"),
        expect_intervention=True,
    ),
    Scenario(
        ...
        description="我想建立家庭维修保养清单习惯，每月检查水电、滤芯和门窗，请监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-12",
            "available_time": {"type": "weekly", "minutes": 30},
            "raw_answers": {"success_criteria": "每月完成家庭维修保养检查清单"},
            "confirm": True,
        },
        feedbacks=("今天检查完了水电和滤芯，但门窗还没看。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [7], "time": "18:30"},
    ),
    Scenario(
        case_id="GOAL-300",
        title="opentelemetry tracing demo",
        description="我想学 OpenTelemetry 和 tracing，做一个服务链路追踪 demo，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点后端接口，不熟 trace 和 span",
            "available_time": {"type": "daily", "minutes": 50},
            "raw_answers": {
                "language_or_track": "OpenTelemetry tracing",
                "project_goal": "服务链路追踪 demo",
            },
            "confirm": True,
        },
        feedbacks=("今天完成了基础 span 上报，但跨服务 trace 还没串起来。",),
        expected_statuses=("partial",),
    ),
]


SCENARIOS_ROUND31: list[Scenario] = [
    Scenario(
        case_id="GOAL-301",
        title="cissp security certification",
        description="我要准备 CISSP 认证，四个月内通过，请安排复习并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-10",
            "available_time": {"type": "daily", "minutes": 70},
            "raw_answers": {"exam_name": "CISSP"},
            "confirm": True,
        },
        feedbacks=("今天完成了安全治理和风险管理章节练习。",),
        expected_statuses=("done",),
    ),
    Scenario(
        case_id="GOAL-302",
        title="nat test japanese n3",
        description="我要准备 NAT-TEST 日语 N3，重点练阅读和听力，请每天监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "N4 到 N3 之间",
            "target_level": "NAT-TEST 日语 N3",
            "available_time": {"type": "daily", "minutes": 40},
            "raw_answers": {"target_language": "日语", "exam_name": "NAT-TEST N3"},
            "confirm": True,
        },
        feedbacks=("今天做了一半阅读题，听力材料还没听完。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-303",
        title="tauri rust desktop app",
        description="我想学 Tauri 和 Rust，做一个桌面待办小工具，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点前端，不熟 Rust 和桌面端打包",
            "available_time": {"type": "daily", "minutes": 50},
            "raw_answers": {
                "language_or_track": "Tauri Rust TypeScript",
                "project_goal": "桌面待办小工具",
            },
            "confirm": True,
        },
        feedbacks=("今天卡在 Tauri command 调用和应用打包配置。",),
        expected_statuses=("blocked",),
    ),
    Scenario(
        case_id="GOAL-304",
        title="cycling cadence endurance",
        description="我想练骑行踏频和耐力，目标两个月内完成 30 公里轻松骑，请每周监督训练。",
        expected_domain="fitness",
        intake={
            "current_level": "目前 15 公里后明显疲劳",
            "available_time": {"type": "weekly", "minutes": 150},
            "constraints": {"health_note": "膝盖不适或路况不好时降低强度"},
            "confirm": True,
        },
        feedbacks=("今天骑了一半计划距离，踏频练习还没做完。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [3, 7], "time": "18:40"},
    ),
    Scenario(
        case_id="GOAL-305",
        title="healthy meal prep habit",
        description="我想建立健康备餐习惯，每周准备三天午餐，减少外卖，请监督。",
        expected_domain="fitness",
        intake={
            "current_level": "经常临时点外卖，备餐不稳定",
            "available_time": {"type": "weekly", "minutes": 90},
            "constraints": {"health_note": "先保证食材新鲜和饮食均衡"},
            "confirm": True,
        },
        feedbacks=("今天买了菜，但没来得及做完三天备餐。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [7], "time": "17:00"},
    ),
    Scenario(
        case_id="GOAL-306",
        title="pte academic speaking",
        description="我要准备 PTE Academic 英语口语，目标两个月提到 65，请每天陪练并监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "发音和流利度不稳定",
            "target_level": "PTE Academic Speaking 65",
            "available_time": {"type": "daily", "minutes": 35},
            "raw_answers": {"target_language": "英语", "exam_name": "PTE Academic"},
            "confirm": True,
        },
        feedbacks=("今天只练了 read aloud，repeat sentence 没时间完成。",),
        expected_statuses=("missed",),
    ),
    Scenario(
        case_id="GOAL-307",
        title="zig systems programming",
        description="我想学 Zig 和系统编程，做一个小型文件扫描 CLI，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点 C，不熟 Zig 构建和内存管理",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {
                "language_or_track": "Zig systems programming",
                "project_goal": "文件扫描 CLI",
            },
            "confirm": True,
        },
        feedbacks=("今天完成了目录遍历，但错误处理和参数解析还没补。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-308",
        title="freestyle swimming breathing",
        description="我想练自由泳换气和连续游 500 米，请每周监督训练。",
        expected_domain="fitness",
        intake={
            "current_level": "能游短距离，但换气容易乱",
            "available_time": {"type": "weekly", "minutes": 120},
            "constraints": {"health_note": "疲劳或呛水明显时降低强度"},
            "confirm": True,
        },
        feedbacks=("今天没去游泳，肩膀有点不舒服。", "今天还是休息了，怕影响恢复。"),
        expected_statuses=("missed", "missed"),
        expect_intervention=True,
        schedule={"type": "weekly", "days": [2, 6], "time": "19:00"},
    ),
    Scenario(
        case_id="GOAL-309",
        title="annual tax documents habit",
        description="我想建立年度报税资料整理习惯，每周归档发票、收入和扣除材料，请监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-12",
            "available_time": {"type": "weekly", "minutes": 45},
            "raw_answers": {"success_criteria": "完成报税资料分类归档和缺口清单"},
            "confirm": True,
        },
        feedbacks=("今天整理完了收入记录，但发票扫描还没做完。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [6], "time": "20:00"},
    ),
    Scenario(
        case_id="GOAL-310",
        title="alibaba cloud acp certification",
        description="我要准备 Alibaba Cloud ACP Cloud Computing Certification，两个月内通过，请安排学习计划并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-08",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {"exam_name": "Alibaba Cloud ACP Cloud Computing Certification"},
            "confirm": True,
        },
        feedbacks=("今天完成了 ECS 和 VPC 基础章节练习。",),
        expected_statuses=("done",),
    ),
]


SCENARIOS_ROUND32: list[Scenario] = [
    Scenario(
        case_id="GOAL-311",
        title="ccna networking certification",
        description="我要准备 CCNA 认证，三个月内通过，请安排复习并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-09",
            "available_time": {"type": "daily", "minutes": 55},
            "raw_answers": {"exam_name": "CCNA"},
            "confirm": True,
        },
        feedbacks=("今天完成了 VLAN、静态路由和一套子网练习题。",),
        expected_statuses=("done",),
    ),
    Scenario(
        case_id="GOAL-312",
        title="hsk5 chinese reading",
        description="我要准备 HSK5 中文考试，重点提升阅读和写作，请每天监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "HSK4 到 HSK5 之间",
            "target_level": "HSK5 阅读和写作达标",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {"target_language": "中文", "exam_name": "HSK5"},
            "confirm": True,
        },
        feedbacks=("今天做了一半阅读题，写作改错还没完成。",),
        expected_statuses=("partial",),
    ...
    Scenario(
        case_id="GOAL-313",
        title="electron sqlite desktop app",
        description="我想学 Electron 和 SQLite，用 JavaScript 做一个桌面记账小工具，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点 JavaScript，不熟 Electron 打包和本地数据库",
            "available_time": {"type": "daily", "minutes": 50},
            "raw_answers": {
                "language_or_track": "Electron SQLite JavaScript",
                "project_goal": "桌面记账小工具",
            },
            "confirm": True,
        },
        feedbacks=("今天卡在 Electron 主进程通信和 SQLite 初始化。",),
        expected_statuses=("blocked",),
    ),
    Scenario(
        case_id="GOAL-314",
        title="rowing machine cardio",
        description="我想练划船机心肺和动作节奏，目标连续划 20 分钟，请每周监督训练。",
        expected_domain="fitness",
        intake={
            "current_level": "目前 8 分钟后动作容易乱",
            "available_time": {"type": "weekly", "minutes": 90},
            "constraints": {"health_note": "腰背不适时降低强度"},
            "confirm": True,
        },
        feedbacks=("今天练了一半划船机节奏，后面的耐力组还没做完。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [2, 5], "time": "19:10"},
    ),
    Scenario(
        case_id="GOAL-315",
        title="wardrobe outfit planning habit",
        description="我想建立每周衣橱整理和穿搭计划习惯，减少早上纠结，请监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-09",
            "available_time": {"type": "weekly", "minutes": 40},
            "raw_answers": {"success_criteria": "每周整理衣橱并准备下一周穿搭"},
            "confirm": True,
        },
        feedbacks=("今天整理完了上衣，但下周穿搭还没搭配完。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [7], "time": "19:00"},
    ),
    Scenario(
        case_id="GOAL-316",
        title="german a2 daily conversation",
        description="我想学德语到 A2，重点练日常对话和听力，请每天陪练并监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "A1 左右",
            "target_level": "德语 A2 日常交流",
            "available_time": {"type": "daily", "minutes": 35},
            "raw_answers": {"target_language": "德语"},
            "confirm": True,
        },
        feedbacks=("今天只练了问路对话，听力材料没时间完成。",),
        expected_statuses=("missed",),
    ),
    Scenario(
        case_id="GOAL-317",
        title="django rest api",
        description="我想学 Django REST Framework，用 Python 做一个图书 API，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点 Python，不熟 Django REST",
            "available_time": {"type": "daily", "minutes": 50},
            "raw_answers": {
                "language_or_track": "Django REST Framework Python",
                "project_goal": "图书 API",
            },
            "confirm": True,
        },
        feedbacks=("今天完成了模型和序列化器，但认证权限还没接好。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-318",
        title="dumbbell strength training",
        description="我想建立哑铃力量训练习惯，提升上肢和核心稳定，请每周监督训练。",
        expected_domain="fitness",
        intake={
            "current_level": "力量基础一般，动作稳定性不够",
            "available_time": {"type": "weekly", "minutes": 100},
            "constraints": {"health_note": "肩肘或腰背不适时降低强度"},
            "confirm": True,
        },
        feedbacks=("今天没训练，肩膀有点不舒服。", "今天还是休息了，怕加重。"),
        expected_statuses=("missed", "missed"),
        expect_intervention=True,
        schedule={"type": "weekly", "days": [1, 4], "time": "19:40"},
    ),
    Scenario(
        case_id="GOAL-319",
        title="personal okr weekly review",
        description="我想建立个人 OKR 每周复盘习惯，记录目标进展、阻碍和下周重点，请监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-12",
            "available_time": {"type": "weekly", "minutes": 45},
            "raw_answers": {"success_criteria": "每周完成 OKR 进展、阻碍和下周重点复盘"},
            "confirm": True,
        },
        feedbacks=("今天写完了目标进展，但阻碍和下周重点还没整理。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [5], "time": "20:30"},
    ),
    Scenario(
        case_id="GOAL-320",
        title="oracle java certification",
        description="我要准备 Oracle Java Certification，两个月内通过，请安排学习计划并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-08",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {"exam_name": "Oracle Java Certification"},
            "confirm": True,
        },
        feedbacks=("今天完成了泛型、集合和异常处理章节练习。",),
        expected_statuses=("done",),
    ),
]


SCENARIOS_ROUND33: list[Scenario] = [
    Scenario(
        case_id="GOAL-321",
        title="aws solutions architect certification",
        description="我要准备 AWS Solutions Architect Associate Certification，三个月内通过，请安排复习并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-09",
            "available_time": {"type": "daily", "minutes": 60},
            "raw_answers": {"exam_name": "AWS Solutions Architect Associate Certification"},
            "confirm": True,
        },
        feedbacks=("今天完成了 IAM、VPC 和高可用架构章节练习。",),
        expected_statuses=("done",),
    ),
    Scenario(
        case_id="GOAL-322",
        title="toeic english listening reading",
        description="我要准备 TOEIC 英语听力和阅读，目标两个月提到 800 分，请每天监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "听力细节题和阅读速度不稳定",
            "target_level": "TOEIC 800",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {"target_language": "英语", "exam_name": "TOEIC"},
            "confirm": True,
        },
        feedbacks=("今天完成了听力 Part 1 和 Part 2，但阅读错题还没整理。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-323",
        title="flutter dart budget app",
        description="我想学 Flutter 和 Dart，做一个手机记账 App，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点前端，不熟 Flutter 状态管理和本地存储",
            "available_time": {"type": "daily", "minutes": 50},
            "raw_answers": {
                "language_or_track": "Flutter Dart",
                "project_goal": "手机记账 App",
            },
            "confirm": True,
        },
        feedbacks=("今天卡在状态管理和本地存储同步。",),
        expected_statuses=("blocked",),
    ),
    Scenario(
        case_id="GOAL-324",
        title="pilates core posture",
        description="我想练普拉提核心稳定和体态改善，请每周提醒并监督训练。",
        expected_domain="fitness",
        intake={
            "current_level": "久坐后腰背容易紧，核心稳定一般",
            "available_time": {"type": "weekly", "minutes": 90},
            "constraints": {"health_note": "腰背疼痛明显时降低强度或停止训练"},
            "confirm": True,
        },
        feedbacks=("今天练了一半核心稳定，最后的拉伸还没做完。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [2, 6], "time": "20:10"},
    ),
    Scenario(
        case_id="GOAL-325",
        title="notion knowledge base habit",
        description="我想建立 Notion 知识库整理习惯，每周整理笔记和标签，请监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-10",
            "available_time": {"type": "weekly", "minutes": 60},
            "raw_answers": {"success_criteria": "每周整理笔记、标签和项目索引"},
            "confirm": True,
        },
        feedbacks=("今天整理完了项目索引，但标签规范还没补。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [6], "time": "19:20"},
    ),
    Scenario(
        case_id="GOAL-326",
        title="delf b2 french writing",
        description="我要准备 DELF B2 法语写作和听力，三个月内考试，请每天监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "B1 到 B2 之间，写作结构不稳定",
            "target_level": "DELF B2 写作和听力达标",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {"target_language": "法语", "exam_name": "DELF B2"},
            "confirm": True,
        },
        feedbacks=("今天没写作文，晚上临时加班。",),
        expected_statuses=("missed",),
    ),
    Scenario(
        case_id="GOAL-327",
        title="terraform aws iac",
        description="我想学 Terraform 和 AWS IaC，做一套可复用基础设施模板，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点云资源配置，不熟 Terraform 模块化",
            "available_time": {"type": "daily", "minutes": 55},
            "raw_answers": {
                "language_or_track": "Terraform AWS IaC",
                "project_goal": "可复用基础设施模板",
        ...
        feedbacks=("今天完成了 VPC 模块，但变量校验和输出说明还没补。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-328",
        title="reduce night screen time",
        description="我想减少睡前刷手机和屏幕时间，建立放松流程，请每天提醒和监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-08",
            "available_time": {"type": "daily", "minutes": 15},
            "raw_answers": {"success_criteria": "睡前减少屏幕时间并完成放松流程"},
            "confirm": True,
        },
        feedbacks=("今天又刷手机到很晚，没控制住。", "今天还是超时了，有点沮丧。"),
        expected_statuses=("missed", "missed"),
        expect_intervention=True,
    ),
    Scenario(
        ...
        description="我想练抱石线路阅读和握力，目标两个月能完成 V3，请每周监督训练。",
        expected_domain="fitness",
        intake={
            "current_level": "目前能完成 V1-V2，线路阅读和握力不稳定",
            "available_time": {"type": "weekly", "minutes": 120},
            "constraints": {"health_note": "手指、手腕或肩肘疼痛时停止训练"},
            "confirm": True,
        },
        feedbacks=("今天卡在抱石线路阅读和发力顺序。",),
        expected_statuses=("blocked",),
        schedule={"type": "weekly", "days": [3, 7], "time": "18:50"},
    ),
    Scenario(
        case_id="GOAL-330",
        title="pmp certification review",
        description="我要准备 PMP 认证，四个月内通过，请安排学习计划并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-10",
            "available_time": {"type": "daily", "minutes": 50},
        ...
        feedbacks=("今天完成了进度管理章节，但错题复盘还没整理。",),
        expected_statuses=("partial",),
    ),
]


SCENARIOS_ROUND34: list[Scenario] = [
    Scenario(
        case_id="GOAL-331",
        title="azure administrator certification",
        description="我要准备 Microsoft Azure Administrator AZ-104 认证，三个月内通过，请安排复习并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-09",
            "available_time": {"type": "daily", "minutes": 55},
            "raw_answers": {"exam_name": "Microsoft Azure Administrator AZ-104"},
            "confirm": True,
        },
        feedbacks=("今天完成了身份管理、虚拟网络和存储账户章节练习。",),
        expected_statuses=("done",),
    ),
    Scenario(
        case_id="GOAL-332",
        title="jlpt n1 listening reading",
        description="我要准备 JLPT N1 日语听力和阅读，目标半年内通过，请每天监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "N2 到 N1 之间，长篇阅读和听力细节不稳",
            "target_level": "JLPT N1 通过",
            "available_time": {"type": "daily", "minutes": 50},
            "raw_answers": {"target_language": "日语", "exam_name": "JLPT N1"},
            "confirm": True,
        },
        feedbacks=("今天做完了两篇阅读，但听力错题还没复盘。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-333",
        title="rust axum postgres api",
        description="我想学 Rust Axum 和 PostgreSQL，做一个任务管理 API，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点 Rust 语法，不熟异步 Web 和数据库连接池",
            "available_time": {"type": "daily", "minutes": 55},
            "raw_answers": {
                "language_or_track": "Rust Axum PostgreSQL",
                "project_goal": "任务管理 API",
            },
            "confirm": True,
        },
        feedbacks=("今天卡在 Axum extractor 和数据库连接池生命周期。",),
        expected_statuses=("blocked",),
    ),
    Scenario(
        case_id="GOAL-334",
        title="jump rope endurance",
        description="我想练跳绳体能和协调性，目标一个月连续跳 10 分钟，请每天提醒和监督训练。",
        expected_domain="fitness",
        intake={
            "current_level": "目前连续跳两分钟就乱，脚踝偶尔紧",
            "available_time": {"type": "daily", "minutes": 20},
            "constraints": {"health_note": "脚踝或膝盖疼痛时停止训练"},
            "confirm": True,
        },
        feedbacks=("今天没跳，脚踝不太舒服。", "今天还是没跳，担心加重。"),
        expected_statuses=("missed", "missed"),
        expect_intervention=True,
    ),
    Scenario(
        ...
        description="我想建立每周预算复盘习惯，记录支出、结余和下周预算，请监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-12",
            "available_time": {"type": "weekly", "minutes": 35},
            "raw_answers": {"success_criteria": "每周完成支出、结余和下周预算复盘"},
            "confirm": True,
        },
        feedbacks=("今天整理完了支出明细，但下周预算还没写。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [7], "time": "20:20"},
    ),
    Scenario(
        case_id="GOAL-336",
        title="topik ii korean speaking writing",
        description="我要准备 TOPIK II 韩语写作和阅读，目标三个月提分，请每天监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "TOPIK II 中级，写作结构不稳定",
            "target_level": "TOPIK II 写作和阅读提分",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {"target_language": "韩语", "exam_name": "TOPIK II"},
            "confirm": True,
        },
        feedbacks=("今天没写作文，晚上太累了。",),
        expected_statuses=("missed",),
    ),
    Scenario(
        case_id="GOAL-337",
        title="power bi sales dashboard",
        description="我想学 Power BI 数据建模和销售仪表盘制作，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点 Excel，不熟 DAX 和数据模型关系",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {
                "language_or_track": "Power BI DAX data modeling",
                "project_goal": "销售仪表盘",
            },
            "confirm": True,
        },
        feedbacks=("今天完成了事实表和维度表建模，但 DAX 度量值还没补。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-338",
        title="regular sleep schedule",
        description="我想调整作息和睡眠时间，建立固定睡前放松流程，请每天提醒和监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-08",
            "available_time": {"type": "daily", "minutes": 20},
            "raw_answers": {"success_criteria": "每天按时开始睡前放松并减少熬夜"},
            "confirm": True,
        },
        feedbacks=("今天又熬到很晚，没做睡前放松。", "今天还是拖延到凌晨，状态不太好。"),
        expected_statuses=("missed", "missed"),
        expect_intervention=True,
    ),
    Scenario(
        case_id="GOAL-339",
        title="yoga hip mobility",
        description="我想练瑜伽髋部灵活性和下背放松，请每周监督训练。",
        expected_domain="fitness",
        intake={
            "current_level": "久坐后髋部紧，下背容易僵",
            "available_time": {"type": "weekly", "minutes": 90},
            "constraints": {"health_note": "下背疼痛明显时降低强度"},
            "confirm": True,
        },
        feedbacks=("今天练了一半髋部打开，最后的下背放松还没做完。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [2, 5], "time": "20:00"},
    ),
    Scenario(
        case_id="GOAL-340",
        title="cfa level 1 certification",
        description="我要准备 CFA Level I 考试，六个月内通过，请安排学习计划并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-11",
            "available_time": {"type": "daily", "minutes": 75},
            "raw_answers": {"exam_name": "CFA Level I"},
            "confirm": True,
        },
        feedbacks=("今天完成了定量方法章节，但错题复盘还没整理。",),
        expected_statuses=("partial",),
    ),
]


SCENARIOS_ROUND35: list[Scenario] = [
    Scenario(
        case_id="GOAL-341",
        title="google cloud architect certification",
        description="我要准备 Google Cloud Professional Cloud Architect Certification，四个月内通过，请安排复习并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-10",
            "available_time": {"type": "daily", "minutes": 60},
            "raw_answers": {"exam_name": "Google Cloud Professional Cloud Architect Certification"},
            "confirm": True,
        },
        feedbacks=("今天完成了 IAM、VPC 和负载均衡章节练习。",),
        expected_statuses=("done",),
    ),
    Scenario(
        case_id="GOAL-342",
        title="ielts writing speaking",
        description="我要准备 IELTS 英语写作和口语，目标三个月到 7 分，请每天陪练并监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "写作 Task 2 结构不稳，口语流利度一般",
            "target_level": "IELTS 写作和口语 7 分",
            "available_time": {"type": "daily", "minutes": 50},
            "raw_answers": {"target_language": "英语", "exam_name": "IELTS"},
            "confirm": True,
        },
        feedbacks=("今天写完了 Task 2 提纲和第一段，但口语录音还没做。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-343",
        title="kubernetes helm gitops",
        description="我想学 Kubernetes、Helm 和 GitOps，做一套应用部署 demo，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点 Docker，不熟 Helm chart 和 GitOps 流程",
            "available_time": {"type": "daily", "minutes": 55},
            "raw_answers": {
                "language_or_track": "Kubernetes Helm GitOps",
                "project_goal": "应用部署 demo",
            },
            "confirm": True,
        },
        feedbacks=("今天卡在 Helm values 分层和 GitOps 同步策略。",),
        expected_statuses=("blocked",),
    ),
    Scenario(
        case_id="GOAL-344",
        title="half marathon base running",
        description="我想练跑步基础，目标半年后完成半程马拉松，请每周监督训练。",
        expected_domain="fitness",
        intake={
            "current_level": "目前能慢跑 5 公里，长距离耐力不足",
            "available_time": {"type": "weekly", "minutes": 180},
            "constraints": {"health_note": "膝盖或脚踝不适时降低强度"},
            "confirm": True,
        },
        feedbacks=("今天练了一半轻松跑，后面的拉伸还没做完。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [2, 4, 7], "time": "19:00"},
    ),
    Scenario(
        case_id="GOAL-345",
        title="personal finance receipts habit",
        description="我想建立每周票据和个人财务整理习惯，记录收入支出和待处理事项，请监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-12",
            "available_time": {"type": "weekly", "minutes": 45},
            "raw_answers": {"success_criteria": "每周整理票据、收入支出和待处理事项"},
            "confirm": True,
        },
        feedbacks=("今天整理完了票据和支出记录，但待处理事项还没补。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [6], "time": "20:10"},
    ),
    Scenario(
        case_id="GOAL-346",
        title="dele b2 spanish",
        description="我要准备 DELE B2 西班牙语考试，重点练阅读和写作，请每天监督。",
        expected_domain="language_learning",
        intake={
            "current_level": "B1 到 B2 之间，写作表达不稳定",
            "target_level": "DELE B2 阅读和写作达标",
            "available_time": {"type": "daily", "minutes": 45},
            "raw_answers": {"target_language": "西班牙语", "exam_name": "DELE B2"},
            "confirm": True,
        },
        feedbacks=("今天没复习，临时有事耽搁了。",),
        expected_statuses=("missed",),
    ),
    Scenario(
        case_id="GOAL-347",
        title="graphql apollo api",
        description="我想学 GraphQL 和 Apollo Server，做一个图书查询 API，请规划并监督。",
        expected_domain="programming_learning",
        intake={
            "current_level": "会一点 Node.js，不熟 schema 设计和 resolver",
            "available_time": {"type": "daily", "minutes": 50},
            "raw_answers": {
                "language_or_track": "GraphQL Apollo Server Node.js",
                "project_goal": "图书查询 API",
            },
            "confirm": True,
        },
        feedbacks=("今天完成了 schema 和基础 resolver，但分页和错误处理还没补。",),
        expected_statuses=("partial",),
    ),
    Scenario(
        case_id="GOAL-348",
        title="reduce sugary drinks",
        description="我想减少含糖饮料和奶茶，建立每天喝水记录习惯，请每天提醒并监督。",
        expected_domain="fitness",
        intake={
            "current_level": "下午经常买奶茶，喝水记录不稳定",
            "available_time": {"type": "daily", "minutes": 5},
            "constraints": {"health_note": "先从替换一杯含糖饮料开始"},
            "confirm": True,
        },
        feedbacks=("今天没记录饮水，下午还是买了奶茶。", "今天又买了甜饮，没控制住。"),
        expected_statuses=("missed", "missed"),
        expect_intervention=True,
    ),
    Scenario(
        case_id="GOAL-349",
        title="digital photo album habit",
        description="我想建立每周数字相册整理习惯，筛选照片、补充日期地点和备份，请监督。",
        expected_domain="general",
        intake={
            "target_date": "2026-11",
            "available_time": {"type": "weekly", "minutes": 50},
            "raw_answers": {"success_criteria": "每周筛选照片、补充日期地点并完成备份"},
            "confirm": True,
        },
        feedbacks=("今天筛完了照片，但日期地点和备份还没做完。",),
        expected_statuses=("partial",),
        schedule={"type": "weekly", "days": [7], "time": "19:30"},
    ),
    Scenario(
        case_id="GOAL-350",
        title="cpa accounting certification",
        description="我要准备 CPA 会计科目考试，五个月内通过，请安排学习计划并监督。",
        expected_domain="exam_certification",
        intake={
            "target_date": "2026-10",
            "available_time": {"type": "daily", "minutes": 70},
...
SCENARIO_SETS = {
    ...
    "round26": SCENARIOS_ROUND26,
    "round27": SCENARIOS_ROUND27,
    "round28": SCENARIOS_ROUND28,
    "round29": SCENARIOS_ROUND29,
    "round30": SCENARIOS_ROUND30,
    "round31": SCENARIOS_ROUND31,
    "round32": SCENARIOS_ROUND32,
    "round33": SCENARIOS_ROUND33,
    "round34": SCENARIOS_ROUND34,
    "round35": SCENARIOS_ROUND35,
}
