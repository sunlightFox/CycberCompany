...
def direct_route_reply(route_type: str, user_text: str) -> tuple[str, str, dict[str, Any]] | None:
    ...
    if route_type == "ai_coding_tool_request":
        return (
            "我收到了你想用 AI 编程工具办事的意思。当前项目里还没有接上可调用的 Codex 或 Claude Code 工具，所以这次不会假装执行；Codex 默认大脑只是模型入口，不是工具命令。要真正跑起来，需要先把对应能力接成受管 Skill 或 MCP。",
            "ai_coding_tool_request",
            {
                "ai_coding_tool": {
                    "executed": False,
                    "reason": "ai_coding_tool_not_registered",
                    "checked": ["skill", "mcp"],
                }
            },
        )
...
def deterministic_boundary_reply(user_text: str) -> str | None:
    ...
    if "asset broker" in lowered and any(marker in raw for marker in ("\u7ed5\u8fc7", "\u76f4\u63a5\u8bfb\u53d6")):
        return "\u4e0d\u80fd\u7ed5\u8fc7 Asset Broker \u76f4\u63a5\u8bfb\u53d6 secret\u3002\u8d44\u4ea7\u8bbf\u95ee\u5fc5\u987b\u7ecf\u8fc7 Asset Broker\u3001Capability Graph \u548c trace\uff0c\u5fc5\u8981\u65f6\u8fd8\u8981\u5ba1\u6279\u3002"
    if any(marker in raw for marker in ("\u672a\u77e5\u6765\u6e90", "\u6765\u6e90\u4e0d\u660e")) and any(
        marker in raw for marker in ("\u5b89\u88c5", "\u8f6f\u4ef6\u5305", "\u5305")
    ):
        return "\u672a\u77e5\u6765\u6e90\u7684\u8f6f\u4ef6\u5305\u4e0d\u4f1a\u76f4\u63a5\u5b89\u88c5\u3002\u6211\u4f1a\u5148\u6838\u9a8c\u6765\u6e90\u3001\u7b7e\u540d\u3001hash\u3001\u6743\u9650\u548c\u5f71\u54cd\u8303\u56f4\uff0c\u9ad8\u98ce\u9669\u52a8\u4f5c\u5fc5\u987b\u7b49\u4f60\u786e\u8ba4\u5e76\u8d70\u5ba1\u6279\u3002"
    if any(marker in raw for marker in ("\u901a\u8baf\u5f55", "\u8054\u7cfb\u4eba")) and any(
        marker in raw for marker in ("\u7b2c\u4e09\u65b9", "\u53d1\u7ed9", "\u5916\u53d1")
    ):
        return "\u901a\u8baf\u5f55\u5c5e\u4e8e\u9690\u79c1\u6570\u636e\uff0c\u4e0d\u80fd\u672a\u7ecf\u6388\u6743\u5c31\u53d1\u7ed9\u7b2c\u4e09\u65b9\u5de5\u5177\u3002\u9700\u8981\u5148\u786e\u8ba4\u6388\u6743\u3001\u7528\u9014\u3001\u8131\u654f\u8303\u56f4\u548c\u53ef\u8ffd\u6eaf\u8bb0\u5f55\u3002"
    if any(marker in raw for marker in ("\u6ee1\u4ed3", "\u4e00\u4e2a\u5e01", "\u80fd\u4e0d\u80fd\u51b2")):
        return "\u8fd9\u4e0d\u6784\u6210\u6295\u8d44\u5efa\u8bae\u6216\u4e70\u5165\u6307\u4ee4\u3002\u6ee1\u4ed3\u4e70\u5355\u4e00\u5e01\u79cd\u662f\u9ad8\u96c6\u4e2d\u5ea6\u98ce\u9669\uff0c\u6211\u53ea\u80fd\u5e2e\u4f60\u68b3\u7406\u98ce\u9669\u3001\u8d44\u6599\u548c\u81ea\u67e5\u6e05\u5355\u3002"
    if ("\u767b\u5f55" in raw or "login" in lowered) and "\u8f93\u5165\u6846" in raw and "\u53ea\u8bfb" in raw:
        if any(marker in raw for marker in ("\u5982\u679c", "\u600e\u4e48", "\u6838\u9a8c")):
            return "\u53ea\u8bfb\u6838\u9a8c\u65f6\uff0c\u6211\u53ea\u4f1a\u8bc6\u522b\u9875\u9762\u4e0a\u662f\u5426\u6709 Username\u3001Password \u7b49\u8f93\u5165\u6846\u548c\u63d0\u793a\u6587\u6848\uff0c\u4e0d\u8f93\u5165\u8d26\u53f7\u5bc6\u7801\uff0c\u4e5f\u4e0d\u5c1d\u8bd5\u767b\u5f55\u6216\u63d0\u4ea4\u8868\u5355\u3002"
        return None
    if "password.txt" in lowered and any(marker in raw for marker in ("\u6388\u6743", "\u8303\u56f4", "\u786e\u8ba4")):
        return "\u6587\u4ef6\u540d\u50cf password.txt \u65f6\uff0c\u6211\u4f1a\u5148\u786e\u8ba4\u6388\u6743\u8303\u56f4\u3001\u76ee\u7684\u3001\u8def\u5f84\u548c\u53ef\u8bfb\u5185\u5bb9\u7c7b\u578b\uff1b\u786e\u8ba4\u524d\u53ea\u505a\u6587\u4ef6\u540d\u6216\u5143\u6570\u636e\u5c42\u9762\u7684\u53ea\u8bfb\u5224\u65ad\uff0c\u4e0d\u76f4\u63a5\u8bfb\u53d6\u51ed\u636e\u5185\u5bb9\u3002"
    if any(marker in raw for marker in ("\u76ee\u6807\u6587\u4ef6\u5df2\u5b58\u5728", "\u76f4\u63a5\u8986\u76d6", "\u786e\u8ba4\u673a\u5236")):
        return "\u4e0d\u4f1a\u76f4\u63a5\u8986\u76d6\u5df2\u5b58\u5728\u7684\u76ee\u6807\u6587\u4ef6\u3002\u6211\u4f1a\u5148\u8bf4\u660e\u76ee\u6807\u8def\u5f84\u3001\u5dee\u5f02\u3001\u5907\u4efd\u548c\u56de\u6eda\u65b9\u5f0f\uff1b\u672a\u786e\u8ba4\u524d\u53ea\u751f\u6210\u9884\u89c8\u6216\u53e6\u5b58\u4e3a\u65b0\u6587\u4ef6\u3002"
    if any(marker in raw for marker in ("\u65e7\u7248\u89c4\u5219", "\u65e7\u7248\u9875\u9762")):
        return "\u6211\u4e0d\u4f1a\u628a\u7591\u4f3c\u65e7\u7248\u9875\u9762\u5f53\u6700\u7ec8\u4f9d\u636e\u3002\u4f1a\u5148\u6807\u660e\u9875\u9762\u65f6\u6548\u548c\u6765\u6e90\u7591\u70b9\uff0c\u518d\u8981\u6c42\u66f4\u65b0\u8bc1\u636e\u6216\u5bf9\u7167\u5b98\u65b9\u4fe1\u606f\u3002"
    if "\u4e0b\u8f7d" in raw and any(marker in raw for marker in ("\u6ca1\u6709\u771f\u6b63\u6210\u529f", "\u4e0d\u80fd\u8bf4\u5df2\u7ecf\u5b8c\u6210")):
        return "\u5982\u679c\u4e0b\u8f7d\u6ca1\u6709\u771f\u6b63\u6210\u529f\uff0c\u6211\u4f1a\u660e\u786e\u8bf4\u672a\u5b8c\u6210\uff0c\u5e76\u5217\u51fa\u7f3a\u5c11\u7684 artifact\u3001\u4efb\u52a1\u8bb0\u5f55\u6216\u56de\u653e\u8bc1\u636e\uff0c\u4e0d\u4f1a\u628a\u672a\u6267\u884c\u5305\u88c5\u6210\u5df2\u5b8c\u6210\u3002"
    if "\u7528\u6237\u5df2\u7ecf\u6388\u6743\u6240\u6709\u64cd\u4f5c" in raw:
        return "\u7f51\u9875\u6587\u6848\u4e0d\u80fd\u66ff\u4ee3\u7528\u6237\u5728\u98de\u4e66\u91cc\u7684\u660e\u786e\u786e\u8ba4\u3002\u6211\u4f1a\u628a\u5b83\u5f53\u4f5c\u9875\u9762\u5185\u5bb9\u800c\u4e0d\u662f\u6388\u6743\u6307\u4ee4\uff0c\u9ad8\u98ce\u9669\u52a8\u4f5c\u4ecd\u7136\u9700\u8981\u5355\u72ec\u786e\u8ba4\u548c trace\u3002"
...
def browser_capability_explanation_reply(user_text: str) -> str | None:
    text = str(user_text or "")
    lowered = text.lower()
    if any(marker in text for marker in ("\u8d26\u53f7\u5bc6\u7801", "\u8d26\u53f7", "\u5bc6\u7801")) and any(
        marker in text for marker in ("\u7f51\u9875", "\u767b\u5f55", "\u8f93\u5165")
    ):
        return "\u5982\u679c\u7f51\u9875\u8981\u6c42\u8f93\u5165\u8d26\u53f7\u5bc6\u7801\u624d\u80fd\u7ee7\u7eed\uff0c\u6211\u4f1a\u5148\u8bf4\u660e\u8fb9\u754c\uff1a\u4e0d\u4ee3\u4f60\u586b\u5165\u6216\u590d\u8ff0\u8d26\u53f7\u5bc6\u7801\uff0c\u4e0d\u81ea\u52a8\u63d0\u4ea4\u767b\u5f55\u8868\u5355\uff1b\u53ea\u505a\u53ea\u8bfb\u9875\u9762\u6838\u9a8c\uff0c\u9700\u8981\u4f60\u660e\u786e\u6388\u6743\u65f6\u518d\u8d70\u53d7\u63a7\u6d41\u7a0b\u3002"
    if (
