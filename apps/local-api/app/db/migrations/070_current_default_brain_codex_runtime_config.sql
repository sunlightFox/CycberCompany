...
SET
  ...
  privacy_policy_json = '{"allow_cloud":true,"provider_display_name":"OpenAI","adapter_family":"openai_compatible","codex_profile":"current_codex","codex_wire_api":"responses","codex_provider":"custom","requires_openai_auth":true,"reasoning_effort":"medium","text_verbosity":"medium","disable_response_storage":true,"approvals_reviewer":"user","api_key_ref_scheme":"codex-auth"}',
  status = 'configured',
