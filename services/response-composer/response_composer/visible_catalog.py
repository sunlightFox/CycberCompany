...
COPY_CATALOG: dict[str, VisibleCopyEntry] = {
    ...
    "boundary.desktop": VisibleCopyEntry(
        "tool_boundary",
        (
            "桌面窗口这类操作我现在不能直接处理，所以不会假装已经做完。要是目标在网页里，我可以换浏览器方式继续帮你看。",
            "桌面控制这块还不够稳，我不会冒充已经执行。网页、文件、命令这些，可以换更靠谱的路径。",
        ),
        tone_strategy="boundary",
    ),
    "boundary.refusal": VisibleCopyEntry(
        "tool_boundary",
        (
            "我懂你的意思，是想让这步继续往前走。安装这类动作会改系统状态，我不能替你跳过确认；你把合法目标和允许范围说清楚，我继续帮你把方案铺开。",
            "这类请求我会先按住，不会替你绕开确认。你把目标和允许范围说清楚，我继续帮你把方案铺开。",
        ),
        tone_strategy="boundary",
    ),
    "boundary.persona": VisibleCopyEntry(
        "tool_boundary",
        (
            "我不是真人，也不是现实中的人，没有隐藏账号能私下登录别的账号。真要做事，我会按合规流程和必要确认来推进。",
            "这点我不绕：我不是真人，也没有隐藏账号。能帮你的事，我会按安全流程和必要工具来做。",
        ),
        tone_strategy="boundary",
    ),
    ...
    "natural.after_edited": VisibleCopyEntry(
        "action_status",
        (
            "{label} 已经按你的修改改好了，我会重新过一遍需要确认的地方。",
            "{label} 已经修改好，我会重新检查一遍，不会把旧目标带下去。",
        ),
    ),
    ...
    "action.pending": VisibleCopyEntry(
        ...
        (
            ...
            "{label} 这边已经摆好，确认前还没动手，只等你一句明确口径。",
        ),
        tone_strategy="boundary",
    ),
